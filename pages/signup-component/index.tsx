          ...
          <div className={style.log_blk}>
            ...
            <div className={style.form_row + " row"}>
              <div className="col-sm-12">
                <h6>Sign up as</h6>
                <div
                  className={`${style.form_blk} ${style.btn_blk} ${style.signup_as_btn_blk}`}
                >
                  <button
                    type="button"
                    name="as_player"
                    ...
                    className={`${style.input} ${
                      signup === "organizer" ? style.active : ""
                    }`}
                    onClick={() => setSignup("organizer")}
                  >
                    Organizer
                  </button>
                  <button
                    ...
                    id="as_player"
                    className={`${style.input} ${
                      signup === "player" ? style.active : ""
                    }`}
                    onClick={() => setSignup("player")}
                  >
                    Player
                  </button>
                </div>
                  ...
                  <div className="col-sm-12">
                    ...
                    <div className={style.form_blk}>
                      <select
                        ...
                        id=""
                        className={style.input}
                        value={organizerData.org_communication_method}
                        onChange={(e) =>
                          setOrganizerData({
                            ...organizerData,
                            org_communication_method: e.target.value,
                          })
                        }
                      >
                        <option value="">Select</option>
            ...
            <div className={style.btn_blk + " " + style.form_blk + " mt-5"}>
              <button
                type="submit"
                className={style.site_btn + " " + style.block}
                onClick={handleSubmitForm}
                disabled={isLoading}
              >
                Register {isLoading ? <i className={style.spinner}></i> : ""}
              </button>
            </div>
