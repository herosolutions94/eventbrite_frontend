...
const AddTeamPopup = (props: any) => {
  ...
  const handleTeamSubmit = async (e: any) => {
    ...
    try {
      const res = await axios.post(
        process.env.API_URL + "/create-team",
        formData,
        {
          headers: {
  ...
  const handleFieldSet = (fieldSet: string) => {
    if (fieldSet == "captain_info") {
      ...
      if (
        runTimeErrors.team_name != "" ||
        runTimeErrors.affiliation != "" ||
        runTimeErrors.team_color != "" ||
        runTimeErrors.skill != ""
      ) {
  ...
  return (
    <>
                  ...
                  {fieldset === "team_info" ? (
                    <>
                      <fieldset>
                          ...
                          <div className="col-sm-6">
                            ...
                            <div className={style.form_blk}>
                              <input
                                ...
                                id=""
                                className={style.input}
                                placeholder="eg: Yellow & Black"
                                onChange={handleChange}
                                value={teamDetails.team_color}
                              />
                              <p className="text-danger">
                                {errors?.team_color}
                              </p>
                          ...
                          <div className="col-sm-6">
                            ...
                            <div className={style.form_blk}>
                              <input
                                ...
                                id=""
                                className={style.input}
                                placeholder="eg: Dutch Eredivisie"
                                onChange={handleChange}
                                value={teamDetails.skill}
                              />
                        ...
                        <div
                          className={`${style.btn_blk} justify-content-center mt-5`}
                        >
                          <button
                            type="button"
                            className={style.site_btn}
                            onClick={() => handleFieldSet("captain_info")}
                          >
                            Continue
                          </button>
                        </div>
                    ...
                    <>
                      <fieldset>
                        <h5 className="mb-5">
                          Team Captain/Manager Information
                        </h5>
                        <div className="row">
                        ...
                        >
                          ...
                          <button
                            type="button"
                            className={style.site_btn}
                            onClick={() => handleFieldSet("members_info")}
                          >
                            Continue
                          </button>
                        </div>
                      ...
                      <fieldset>
                          ...
                          <div className="col-sm-6">
                            ...
                            <div className={style.form_blk}>
                              <input
                                ...
                                id="role"
                                className={style.input}
                                placeholder="eg: Captain"
                                value={teams.role}
                                onChange={(e) =>
                                  setTeams({ ...teams, role: e.target.value })
                                }
                              />
                            </div>
                          </div>
                                ...
                                {teamMembers.map((team: any, index: number) => (
                                  <tr key={index}>
                                    ...
                                    <td>
                                      <button
                                        type="button"
                                        className={style.text_prime}
                                        onClick={deleteMemberHandle}
                                      >
                                        Delete
                                      </button>
                                    </td>
                        ...
                        >
                          <button
                            type="button"
                            className={`${style.site_btn} ${style.simple}`}
                            onClick={() => setFieldset("captain_info")}
                          >
                            Back
                          </button>
                          <button
                      ...
                      <fieldset>
                        ...
                        >
                          <button
                            type="button"
                            className={`${style.site_btn} ${style.simple}`}
                            onClick={() => setFieldset("members_info")}
                          >
                            Back
                          </button>
                          <button
                            type="button"
                            className={style.site_btn}
                            onClick={() => setFieldset("liability_info")}
                          >
                            Continue
                          </button>
                        </div>
                    ...
                    <>
                      <fieldset>
                        ...
                        {/* <p className="mb-5 opacity-50">
                          Please make sure each team member reads and signs the
                          waivers and liability forms provided. Upload the
                          signed forms here (if using an online form, allow file
                          upload, or provide an email address to receive the
                          forms)
                        </p> */}
                        <div className="row">
                          {/* <div className="col-sm-6">
                            ...
                            <div className={style.form_blk}>
                              <input
                                ...
                                className={style.input}
                                placeholder="eg: sample@gmail.com"
                                value={teamDetails.waivers_email}
                                onChange={handleChange}
                              />
                              <p className="text-danger">
                                {errors?.waivers_email}
                              </p>
                            </div>
                          </div>
                          <div className="col-sm-6">
                            ...
                            <div className={style.form_blk}>
                              <div className={style.lbl_btn}>
                                ...
                                <label htmlFor="confirm">
                                  ...
                                  you have read and understood the tournament{" "}
                                  <Link
                                    target="_blank"
                                  ...
                                  . You also agree to abide by the rules and
                                  regulations set forth by the tournament
                                  organizers.
                                </label>
                              </div>
                            </div>
      ...
      {deleteMember ? (
        <ConfirmDeletionPopup popupClose={deleteMemberHandle} />
      ) : null}
    </>
  );
};
